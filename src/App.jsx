    ...
    return (
      ...
      `}</style>
            ...
            <ColorBends
                rotation={0}
                speed={0.2}
                colors={["#858585", "#454545", "#0086ff", "#f4900c"]}
                transparent
                autoRotate={0}
                scale={1}
                frequency={1}
                            ...
                            <div style={{ position: "relative", maxWidth: "820px", width: "100%" }}>
                                <div style={{ opacity: 0, animation: "fadeUp 0.8s 0.1s forwards" }}>
                                    <div style={{ marginBottom: "2rem", display: "inline-block" }}>
                                        <p className="section-label" style={{
                                            ...
                                            borderRadius: "100px",
                                            background: "rgba(244,144,12,0.22)",
                                            border: "1px solid rgba(244,144,12,0.5)",
                                            backdropFilter: "blur(12px)",
                                            WebkitBackdropFilter: "blur(12px)",
                                            boxShadow: "0 2px 16px rgba(244,144,12,0.18), inset 0 1px 0 rgba(255,255,255,0.12)",
                                ...
                                <div style={{ opacity: 0, animation: "fadeUp 0.8s 0.35s forwards" }}>
                                    <p style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 300, fontSize: "clamp(1rem, 2vw, 1.2rem)", color: t.textMuted, maxWidth: "520px", lineHeight: 1.7, margin: "0 auto 2.5rem", textShadow: "0 2px 12px rgba(0,0,0,0.5)" }}>
                                        Experience videos that{" "}
                                        <mark style={{
                                            background: "linear-gradient(104deg, transparent 0%, rgba(0,134,255,0.22) 10%, rgba(0,134,255,0.3) 50%, rgba(0,134,255,0.22) 90%, transparent 100%)",
                                            color: "inherit", borderRadius: "3px", padding: "0.05em 0.25em",
                                            WebkitBoxDecorationBreak: "clone", boxDecorationBreak: "clone",
                                        }}>elevate your brand</mark>{" "}and storytelling.
                                    </p>
                                </div>
                                <div style={{ opacity: 0, animation: "fadeUp 0.8s 0.5s forwards", display: "flex", gap: "1rem", flexWrap: "wrap", justifyContent: "center", alignItems: "center" }}>
                                    <a onClick={goVideos} className="cta-btn filled" style={{ cursor: "pointer", background: "rgba(240,240,236,0.52)", borderColor: "rgba(255,255,255,0.65)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", boxShadow: "0 2px 16px rgba(255,255,255,0.1), inset 0 1px 0 rgba(255,255,255,0.18)", color: "rgba(180,180,175,0.9)" }}>View Work</a>
